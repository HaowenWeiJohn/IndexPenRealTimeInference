...
# from interfaces.IndexPenInferenceInterface import IndexPenInferenceInterface
...
if __name__ == '__main__':
    ...
    # main window init
    # inference_interface = IndexPenInferenceInterface()
    window = MainWindow(app=app, inference_interface=None)
