...
class IndexPenInference(QtWidgets.QWidget):
    def __init__(self, parent):
        ...
        self.indexpeninference_text_layout, self.indexpeninference_text_input = init_textEditInputBox(parent=self.indexpeninference_display_layout,
...
###########################################################
        ...
        self.indexpeninference_lslname_layout, self.indexpeninference_lslname_input = init_inputBox(parent=self.indexpeninference_lslconnection_control_layout,
                                                                      label='IndexPen mmWave LSL Outlet Name :',
                                                                      default_input=config_ui.mmWave_lsl_outlet_name_default)
        self.connect_mmwave_lsl_btn = init_button(parent=self.indexpeninference_lslconnection_control_layout, label='Connect mmWave LSL')
        ...
        self.indexpeninference_modelpath_layout, self.indexpeninference_modelpath_input = init_inputBox(parent=self.indexpeninference_modelselection_layout,
                                                                      label='IndexPen Model Path :',
                                                                      default_input=config_ui.mmWave_lsl_outlet_name_default)
        self.load_indexpen_model_btn = init_button(parent=self.indexpeninference_modelselection_layout, label='Load IndexPen Model')
